...
public class CamposaguaDAOImpl extends BaseDAOHibernate implements CamposaguaDAO {
	...
	public Tendido findByIdTendido6(Long id) {
		return findFirst(Tendido.class, "FROM Tendido  where" + " NombreTendido = " + 6 );
	}

	public Cajaregistradora findByIdCajaregistradora6(Long id) {
		return findFirst(Cajaregistradora.class, "FROM Cajaregistradora  where" + " NombreCajaregistradora = " + 6 );
	}

	public Tendido findByIdTendido160(Long id) {
		return findFirst(Tendido.class, "FROM Tendido  where" + " NombreTendido = " + 160 );
	}

	public Cajaregistradora findByIdCajaregistradora160(Long id) {
		return findFirst(Cajaregistradora.class, "FROM Cajaregistradora  where" + " NombreCajaregistradora = " + 160);
	}

	public Tendido findByIdTendido200(Long id) {
		return findFirst(Tendido.class, "FROM Tendido  where" + " NombreTendido = " +200 );
	}

	public Cajaregistradora findByIdCajaregistradora200(Long id) {
		return findFirst(Cajaregistradora.class, "FROM Cajaregistradora  where" + " NombreCajaregistradora = " + 200);
	}
