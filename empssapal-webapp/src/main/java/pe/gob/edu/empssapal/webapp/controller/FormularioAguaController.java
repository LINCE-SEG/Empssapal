...
public class FormularioAguaController {
	...
	public String guardarpresupuestoagua15(
		...
		Double Medida = FormularioAgua.getDistancia()*0.6;
		...
		//reporte de rotura
				Rotura rotura = empssapalService.findbyidrotura(FormularioAgua.getPista().getId());
				model.addAttribute("rotura", rotura);
		//reporte de reposicion
				Reposicion reposicion = empssapalService.findbyidreposicion(FormularioAgua.getPista().getId());
